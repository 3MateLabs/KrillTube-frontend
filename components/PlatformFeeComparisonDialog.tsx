    ...
    >
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-xl font-semibold text-foreground">Platform Fee Comparison</h3>
          <button
            onClick={onClose}
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border">
                ...
                <th className="text-left py-3 px-4 font-semibold text-foreground">Platform Fee</th>
                <th className="text-left py-3 px-4 font-semibold text-foreground">Creator Gets</th>
              </tr>
            </thead>
            <tbody className="text-text-muted">
              <tr className="border-b border-border/50">
                <td className="py-3 px-4">
                  <span className="font-medium text-walrus-mint">KrillTube</span>
                </td>
                <td className="py-3 px-4 text-walrus-mint font-semibold">10%</td>
                <td className="py-3 px-4 text-walrus-mint font-semibold">90%</td>
              </tr>
              <tr className="border-b border-border/50">
                <td className="py-3 px-4">
                  <a
        ...
        <div className="mt-6 p-4 bg-walrus-mint/10 border border-walrus-mint/30 rounded-lg">
          <p className="text-sm text-foreground">
            <span className="font-semibold text-walrus-mint">Why 10%?</span> This fee helps us maintain infrastructure, provide reliable service, and continue improving the platform for creators like you.
          </p>
        </div>
