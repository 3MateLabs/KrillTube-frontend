...
export function Sidebar({ isOpen = true, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      >
        {/* Logo */}
        <div className="w-56 mx-[29px] mt-[18px] inline-flex justify-start items-center gap-3">
        ...
        {/* Navigation */}
        <div className="w-56 mx-[29px] mt-[17px] mb-6 inline-flex flex-col justify-start items-start gap-4">
          {/* Main Menu */}
