  ...
  return (
    <>
      ...
      <div className="flex min-h-screen bg-gradient-to-br from-[#0668A6] via-[#0668A6] to-[#1AAACE]">
        ...
        />
        <main className={`flex-1 min-h-screen pt-[60px] bg-gradient-to-br from-[#0668A6] via-[#0668A6] to-[#1AAACE] transition-all duration-300 ${isSidebarCollapsed ? 'lg:ml-20' : 'lg:ml-72'}`}>
          {children}
        </main>
      </div>
    </>
