      ...
      <div className="flex flex-col justify-between items-start flex-1 py-1">
        ...
        <div className="flex flex-col items-start gap-2 w-full">
          ...
          <div className="flex items-center justify-between w-full">
            ...
            <button className="flex items-center gap-2 px-3 py-1.5 bg-[#0668A6] rounded-[8px] border-[2px] border-black shadow-[2px_2px_0px_0px_#000000] hover:shadow-[1px_1px_0px_0px_#000000] hover:translate-x-[1px] hover:translate-y-[1px] transition-all">
        ...
        <div className="relative z-10 h-full px-8">
          ...
          <div className="absolute left-8 bottom-6 flex flex-row items-end gap-10">
            ...
            <button
              ...
              className={`px-6 py-2 rounded-full shadow-[2px_2px_0px_0px_rgba(0,0,0,1.00)] outline outline-[2px] outline-offset-[-2px] outline-black text-sm font-semibold font-['Outfit'] transition-all hover:shadow-[1px_1px_0_0_black] hover:translate-x-[1px] hover:translate-y-[1px] ${
                isSubscribed
                  ? 'bg-black text-white'
                  : 'bg-gradient-to-br from-[#EF4330]/70 to-[#1AAACE]/70 text-white'
              }`}
            >
